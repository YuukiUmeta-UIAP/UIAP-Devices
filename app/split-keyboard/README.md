...
- バージョン1.1です。
- Windows 10/11、Ubuntu22.04/24.04で動作確認できています。
...
<img src=".src/img/PXL_20250120_132242160.jpg" alt="改造" style="width:32%"><img src=".src/img/PXL_20250120_132301329.jpg" alt="改造" style="width:32%"><img src=".src/img/PXL_20250121_151223214.jpg" alt="改造" style="width:32%">  
<img src=".src/img/PXL_20250121_151257683.jpg" alt="改造" style="width:32%"><img src=".src/img/PXL_20250505_040332651.jpg" alt="改造" style="width:32%"><img src=".src/img/PXL_20250122_151522777.jpg" alt="改造" style="width:32%">  

2. [Self-Made Keyboards in Japan](https://scrapbox.io/self-made-kbds-ja/)のDiscordサーバでIKeJIとデバッグ

3. 動作確認できたので基板設計してJLCPCBに基板製造とPCBAを発注
...
初の自作キーボードでしたが、とても楽しく作ることができました。また、IKeJIさんのフォローのおかげででとても簡単に作れました。特にキーボードとして振る舞う通信部分とキーマトリクスの説明を細かくしてくれました。改めて感謝申し上げます。